...
class HandleUnits {
  Widget getProjectsInformation(BuildContext context) {
    ...
    return Column(
      children: [
        SizedBox(height:25),
        DisplayHandleUnits(project: firstProject, unitsId: "1",),
        SizedBox(height:25),
        DisplayHandleUnits(project: secondProject, unitsId: "2",),
        SizedBox(height:25),
        DisplayHandleUnits(project: thirdProject, unitsId: "3",),
        SizedBox(height:25),
        DisplayHandleUnits(project: firstProject, unitsId: "4",),
        SizedBox(height:25),
        DisplayHandleUnits(project: secondProject, unitsId: "5",),
        SizedBox(height:25),
        DisplayHandleUnits(project: thirdProject, unitsId: "6",),
        SizedBox(height:25),
        DisplayHandleUnits(project: firstProject, unitsId: "7",),
        SizedBox(height:25),
        DisplayHandleUnits(project: secondProject, unitsId: "8",),
        SizedBox(height:25),
        DisplayHandleUnits(project: thirdProject, unitsId: "9",),
        SizedBox(height:25),
        DisplayHandleUnits(project: firstProject, unitsId: "10",),
        SizedBox(height:25),
        DisplayHandleUnits(project: secondProject, unitsId: "11",),
        SizedBox(height:25),
        DisplayHandleUnits(project: thirdProject, unitsId: "12",),
        SizedBox(height:25),
      ],
    );
  }
